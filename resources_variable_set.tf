...
resource "tfe_variable_set" "this" {
  for_each = { for variable_set in local.variable_sets : variable_set.name => variable_set }
...
resource "tfe_project_variable_set" "this" {
  for_each = { for variable_set in local.project_variable_sets : "${variable_set.name} ${variable_set.project}" => variable_set }
...
resource "tfe_workspace_variable_set" "this" {
  for_each = { for variable_set in local.workspace_variable_sets : "${variable_set.name} ${variable_set.workspace}" => variable_set }
